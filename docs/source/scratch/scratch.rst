...
.. note::
    ...
    Before attempting the projects, make sure you have downloaded the necessary materials and code files.[Download code to Raspberry Pi](../preparation/Download_the_Code.md# Download the Code)
.. toctree::
    :maxdepth: 2
